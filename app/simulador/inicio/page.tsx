      ...
      <GlassCard>
        <div className="space-y-6">
          <div className="space-y-2 text-center">
            <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-brandBright">Passo 1 de 5</p>
            <h1 className="text-2xl font-semibold leading-tight sm:text-3xl">Cria o teu Perfil Financeiro</h1>
            <p className="text-sm leading-relaxed text-soft">
              Vamos enviar a tua análise personalizada directamente para o teu WhatsApp. É rápido e gratuito.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="mx-auto w-full max-w-md space-y-4">
            ...
            <PrimaryButton type="submit" loading={loading}>Iniciar análise gratuita →</PrimaryButton>

            <p className="text-center text-[10px] text-muted">
              Não partilhamos os teus dados. Apenas usamos para te enviar os resultados.
            </p>
          </form>
        </div>
      </GlassCard>
